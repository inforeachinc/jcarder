...
public final class InstrumentationUtilities {
    ...
    public static void pushClassReferenceToStack(MethodVisitor mv, String className, int version) {
        if (version >= Opcodes.V1_5)
        {
            mv.visitLdcInsn(Type.getObjectType(getInternalName(className)));
        }
        else
        {
            /*
